...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Code Overview &#8212; pgAdmin 4 3.0 documentation</title>
...
<span id="id1"></span><h1>Code Overview<a class="headerlink" href="#code-overview" title="Permalink to this headline">¶</a></h1>
...
<li>Be placed within the <strong>web/pgadmin/</strong> directory, and</li>
<li>Implements pgadmin.utils.PgAdminModule class</li>
<li>An instance variable (generally - named <strong>blueprint</strong>) representing that
particular class in that package.</li>
</ol>
...
<ol class="arabic simple">
<li>Be placed within the <strong>web/pgadmin/browser/</strong> directory, and</li>
<li>Implements the BrowserPluginModule, and registers the node view, which
exposes required the REST APIs</li>
<li>An instance of the class object</li>
</ol>
</div>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Code Overview</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#runtime">Runtime</a></li>
<li class="toctree-l3"><a class="reference internal" href="#web-application">Web Application</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#configuration">Configuration</a></li>
<li class="toctree-l4"><a class="reference internal" href="#user-settings">User Settings</a></li>
</ul>
</li>
<li class="toctree-l3"><a class="reference internal" href="#pgadmin-core">pgAdmin Core</a></li>
