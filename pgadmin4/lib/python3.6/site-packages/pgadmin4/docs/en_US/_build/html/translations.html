...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Translations &#8212; pgAdmin 4 3.0 documentation</title>
...
is achieved.</p>
<p>Python:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">errormsg</span> <span class="o">=</span> <span class="n">gettext</span><span class="p">(</span><span class="s1">&#39;No server group name was specified&#39;</span><span class="p">)</span>
</pre></div>
</div>
<p>Jinja:</p>
...
catalogues (<strong>web/pgadmin/translations/$LANG/LC_MESSAGES/messages.po</strong>) must be updated
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Translations</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#translation-marking">Translation Marking</a></li>
<li class="toctree-l3"><a class="reference internal" href="#updating-and-merging">Updating and Merging</a></li>
<li class="toctree-l3"><a class="reference internal" href="#adding-a-new-language">Adding a New Language</a></li>
</ul>
</li>
</ul>
</li>
