...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Submitting Patches &#8212; pgAdmin 4 3.0 documentation</title>
    ...
    <link rel="prev" title="pgAdmin Project Contributions" href="contributions.html" /> 
  </head><body>
...
<span id="id1"></span><h1>Submitting Patches<a class="headerlink" href="#submitting-patches" title="Permalink to this headline">¶</a></h1>
<p>Before developing a patch for pgAdmin you should always contact the developers
on the mailing list <a class="reference external" href="mailto:pgadmin-hackers&#37;&#52;&#48;postgresql&#46;org">pgadmin-hackers<span>&#64;</span>postgresql<span>&#46;</span>org</a> to discuss your
...
writing code that may later be rejected.</p>
<p>You should always develop patches against a checkout of the source code from the
...
patches correctly. You can checkout the source code with a command like:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ git clone git://git.postgresql.org/git/pgadmin4.git
</pre></div>
</div>
<p>Once you’ve made the changes you wish to make, commit them to a private
...
might run:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ git diff origin/master &gt; my_cool_feature.diff
</pre></div>
</div>
<p>to create a patch between your development branch and the public master branch.</p>
<p>You can also create patches directly from the development tree, for example:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ git diff &gt; my_cool_feature.diff
</pre></div>
</div>
<p>If you are adding new files, you may need to stage them for commit, and then
create your patch against the staging area. If any of the files are binary,
for example, images, you will need to use the <em>–binary</em> option:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ git add file1.py file2.py images/image1.png [...]
$ git diff --cached --binary &gt; my_cool_feature.diff
</pre></div>
</div>
<p>Once you have your patch, check it thoroughly to ensure it meets the pgAdmin
<a class="reference internal" href="coding_standards.html"><span class="doc">Coding Standards</span></a>, and review it against the <a class="reference internal" href="code_review.html"><span class="doc">Code Review Notes</span></a> to minimise
the chances of it being rejected. Once you’re happy with your work, mail it
as an attachment to the mailing list <a class="reference external" href="mailto:pgadmin-hackers&#37;&#52;&#48;postgresql&#46;org">pgadmin-hackers<span>&#64;</span>postgresql<span>&#46;</span>org</a>.
Please ensure you include a full description of what the patch does,
as well as the rationale for any important design decisions.</p>
</div>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Submitting Patches</a></li>
